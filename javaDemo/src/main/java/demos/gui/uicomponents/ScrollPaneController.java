...
public class ScrollPaneController {
    ...
    public void init() {
        for (int i = 0; i < 100; ++i) {
            this.contentList.getItems().add("Item " + i);
        }

        this.contentList.setMaxHeight(3400.0);
        JFXScrollPane.smoothScrolling((ScrollPane) this.scroll.getChildren().get(0));
        ...
        this.backButton.setGraphic(arrow);
        this.backButton.setRipplerFill(Color.WHITE);
    }
}