 ...
 * @date 2023/5/30
 */
public class MyDemolApplicationTest extends Application {

    @Override
    public void start(Stage primaryStage) throws Exception {

        ResourceBundle resourceBundle = ResourceBundle.getBundle("demo.Menu");

        FXMLLoader loader = new FXMLLoader(getClass().getResource("/demo/Index.fxml"), resourceBundle);

        //Parent root = FXMLLoader.load(getClass().getResource("/demo/Index.fxml"));
