...
public class TreeViewDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        this.rootNode.predicateProperty().bind(Bindings.createObjectBinding(() -> {
            return filterField.getText() != null && !filterField.getText().isEmpty() ? TreeItemPredicate.create((actor) -> {
            ...
            this.filteredList.predicateProperty().bind(Bindings.createObjectBinding(() -> {
                return (child) -> {
                    ...
                    if (this.predicate.get() == null) {
                        ...
                        return child.getChildren().size() > 0 ? true : ((TreeItemPredicate) this.predicate.get()).test(this, child.getValue());
                    }
                };
